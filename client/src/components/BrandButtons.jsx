...
const BrandButtons = () => { 
    ...
    return (
        <div className="brand-buttons">
            <button onClick={() => navigate('/sneakers/nike')} className="brand-button">
            ...
            <button onClick={() => navigate('/sneakers/adidas')} className="brand-button">
            ...
            <button onClick={() => navigate('/sneakers/reebok')} className="brand-button">
                <img src="https://i2.wp.com/elpoderdelasideas.com/wp-content/uploads/rebook-logo-2.jpg" alt="Reebok" />
            </button>
            <button onClick={() => navigate('/sneakers/vans')} className="brand-button">
